...
describe('ChatWidget language welcome sync', () => {
  test('updates initial assistant welcome when language changes', () => {
    ...
    // Default language is Auto -> falls back to English welcome in UI
    ...
    // Change language to Spanish via the language selector
    ...
    expect(screen.queryByText(enWelcome)).toBeNull()
  })
})
